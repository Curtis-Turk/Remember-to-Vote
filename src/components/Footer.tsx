  ...
  return (
    <div id="footer">
      ...
      <p id="gdpr-text">
        ...
        record held on our electoral database, which could inform future communications you receive
        from us. We may use your answers to help us campaign better. If signing up for an event, we
        may still use the details provided to contact you specifically about that event. If you
